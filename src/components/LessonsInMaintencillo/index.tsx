...
const PAGE: string = "lessonMaintencillopage";
const LessonsInMaintencillo = () => {
  return (
    <>
      ...
      <div className="mt-20 relative z-1 mx-auto w-full max-w-[1170px] px-4 sm:px-8 xl:px-0">
        <section className="mb-12">
          ...
          <p className="mb-4.5 font-satoshi text-lg  text-slate-700 ">
            ...
            <strong>Miniswimmer</strong> con una clase de prueba. Es la
            oportunidad perfecta para que conozcas nuestra innovadora
            metodología, basada en la{" "}
            <strong>Programación Neurolingüística (PNL)</strong> y el{" "}
            <strong>Coaching</strong>, diseñada para un aprendizaje real y
            significativo.
          </p>
        </section>
      </div>
...
export default LessonsInMaintencillo;

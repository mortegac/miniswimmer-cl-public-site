...
const features = [
  ...
  },
  {
    ...
    competitor: "Solo español. Sin presencia fuera de Santiago.",
    winner: "miniswimmer",
  },
  {
        ...
        <div className="mx-auto w-full max-w-[1170px] px-4 sm:px-8 xl:px-0">
          <div className="text-center">
            ...
            <p className="mx-auto mb-8 max-w-[680px] text-lg text-slate-100">
              Comparamos programas, metodología, sedes y más — para que elijas
              con información real cuál academia es la mejor para tu familia.
            </p>
            <Link
              href={WHATSAPP_URL}
              target="_blank"

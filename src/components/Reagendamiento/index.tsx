      ...
      <div className="mt-36 relative z-1 mx-auto w-full max-w-[1170px] px-4 sm:px-8 xl:px-0">
        <section className="mb-12">
          ...
          <p className="mb-4.5 font-satoshi text-lg  text-slate-700 ">
            Para reagendar una clase, debe completar todos los campos del
            formulario con un mínimo de 12 horas de anticipación; si la
            solicitud supera este tiempo, no será válida y la clase se perderá.
          </p>
        </section>
      </div>

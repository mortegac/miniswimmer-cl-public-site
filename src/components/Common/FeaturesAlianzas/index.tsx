          ...
          {features?.map((data: any, i) => (
            ...
            >
              ...
              >
                ...
                <div
                  id="code"
                  className="text-center w-[90%] absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-[#ae5eab] text-white px-2 py-2 rounded-md font-thin text-sm"
                >
                  <p>
                    Usa el código: <b>{data?.codigo}</b>
                  </p>
                </div>
              </div>

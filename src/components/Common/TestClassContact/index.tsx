  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      const templateParams = {
        ...
        html_title:
          "<h2>Solicitud de clase de Prueba</h2><p>Hemos recibido tu solicitud y te responderemos lo antes posible.</p>",
              ...
              >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-8 sm:mb-12">
                    {SERVICIOS.map((servicio) => (
                      ...
                      >
                        ...
                        />
                        <span className="text-sm text-[rgba(0,17,51,0.8)] dark:text-gray-300">
                          {servicio}
                        </span>
                      </label>
                    ))}
                ...
                <div>
                  ...
                  >
                    ...
                    <p className="-mt-1 text-[.9rem] text-gray-500">
                      La fecha de tu clase de prueba dependerá de los cupos
                      disponibles según el servicio y día seleccionado.
                    </p>
                  </label>
                  {errors.fecha && (

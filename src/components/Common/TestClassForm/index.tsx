...
const generateAvailableDates = (startDateStr: string, endDateStr: string): AvailableDate[] => {
  ...
  while (currentDate <= endDateObj) {
    ...
    if (currentDate.getDay() === 4) { // 4 = jueves
                  ...
                  <div id="availableDates" className="w-full">
                    ...
                    <div id="slots" className="space-y-4 sm:space-y-6 h-64 sm:h-80 lg:h-96 overflow-y-auto pr-2">
                      {Object.entries(
                        ...
                        <div key={date} className="bg-white/10 rounded-lg p-3 sm:p-4 backdrop-blur-sm">
                    ...
                    {availableDate.length === 0 && (
                      <div className="text-center text-white py-6 sm:py-8">
                        <p className="text-base sm:text-lg">No hay fechas disponibles en este momento.</p>
                        <p className="text-sm opacity-80">Por favor, intenta más tarde.</p>
                      </div>
                    )}
                  </div>
                </div>
                  ...
                  <div className="space-y-6 sm:space-y-8">
                    ...
                    <div className="relative flex items-start">
                      ...
                      <div className="ml-4 sm:ml-6 pt-1 sm:pt-2">
                        ...
                        <p className="text-white/90 leading-relaxed text-sm sm:text-base">
                          Nuestra página te guiará al carro de compras para que finalices la reserva de forma segura. 
                          Puedes pagar con <strong>tarjeta de débito o crédito</strong>.
                        </p>
                      </div>
                    </div>
                  </div>

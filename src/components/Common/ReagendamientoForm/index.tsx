  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      const templateParams = {
        ...
        html_title:
          "<h2>Solicitud de reagendamiento</h2><p>Hemos recibido tu solicitud de reagendamiento y te responderemos lo antes posible.</p>",
            ...
            {isSentEmail.sentEmail ? (
              ...
              >
                ...
                <div>
                  <label
                    htmlFor="fecha"
                    className="block text-base sm:text-lg font-light text-gray-700 mb-10"
                  >
                    Seleccione la fecha de su clase
                    <p className="-mt-1 text-[.9rem] text-red-700">
                      (Si su fecha no aparece, no es posible reagendarla.)
                    </p>
                  </label>
                  {errors.fecha && (
                  ...
                  <div id="availableDates" className="w-full">
                    ...
                    <div id="slots" className="space-y-4 sm:space-y-6 pr-2">
                      <div
                        key={"clases"}
                        className="bg-white/10 rounded-lg p-0 sm:p-0 backdrop-blur-sm"
                      >
                        <div
                          id="listSessions"
                ...
                {selectedSlot.slotId && (
                  <div className="mt-4 p-3 sm:p-4 border border-[#ae5eab] rounded-lg">
                    <p className="text-[#ae5eab] font-medium text-sm sm:text-base">
                      Fecha seleccionada:{" "}
                      <strong>
                        {selectedSlot.date || selectedSlot.slotId}
                      </strong>
                    </p>
          ...
          <div className="w-full lg:flex-1 p-4 sm:p-6 lg:p-[48px] flex flex-col justify-start items-start relative">
            <div className="w-full px-2 sm:px-4 lg:px-0 flex flex-col justify-start items-start">
                  ...
                  <div className="space-y-6 sm:space-y-8">
                    ...
                    <div className="relative flex items-start">
                      ...
                      <div className="ml-4 sm:ml-6 pt-1 sm:pt-2">
                        ...
                        <p className="text-white/90 leading-relaxed text-sm sm:text-base">
                          Completa todos los campos del formulario con al menos
                          12 horas de anticipación a tu clase; de lo contrario,
                          la solicitud no será válida y la clase se perderá.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="relative flex items-start">
                      ...
                      <div className="ml-4 sm:ml-6 pt-1 sm:pt-2">
                        ...
                        <p className="text-white/90 leading-relaxed text-sm sm:text-base">
                          Elige el nuevo día y hora que mejor se adapten a tu
                          horario entre las opciones disponibles y según la
                          validez de tu paquete.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="relative flex items-start">
                      ...
                      <div className="ml-4 sm:ml-6 pt-1 sm:pt-2">
                        ...
                        <p className="text-white/90 leading-relaxed text-sm sm:text-base">
                          Nuestro equipo revisará tu caso y te contactará para
                          confirmar el reagendamiento. Trabajamos en horario
                          hábil de lunes a viernes, de 09:00 a 18:00 hrs.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <section className="mt-8 sm:mt-12">
                <p className="text-white/90 leading-relaxed text-sm sm:text-base">
                  ¡Así de simple! En pocos pasos habrás gestionado tu solicitud
                  para seguir disfrutando de las clases en nuestras sedes. ¡Nos
                  vemos en el agua!
                </p>
              </section>
            </div>

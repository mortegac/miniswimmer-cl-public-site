...
const features = [
  ...
  },
  {
    ...
    competitor:
      "Solo español. Sin presencia fuera de Chile.",
    winner: "miniswimmer",
  },
];
        ...
        <div className="mx-auto w-full max-w-[1170px] px-4 sm:px-8 xl:px-0">
          <div className="text-center">
            ...
            <p className="mx-auto mb-8 max-w-[680px] text-lg text-slate-100">
              ¿Clases de natación en un club deportivo o en una academia especializada? Comparamos programas, metodología, instructores y experiencia para que decidas con información real.
            </p>
            <Link
              href={WHATSAPP_URL}
              target="_blank"
            ...
            <div key={f.label} className="rounded-xl border border-slate-200 p-4 shadow-sm">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <p className="text-xs font-semibold text-slate-500">Club Recrear</p>
          ...
          <table className="w-full table-fixed text-sm">
            <thead>
              <tr className="bg-slate-50">
                ...
                <th className="w-[37.5%] px-6 py-4 text-left font-satoshi text-xs font-bold uppercase tracking-wider text-slate-400">Club Recrear</th>
              </tr>
            </thead>
      ...
      <section className="mt-20 bg-slate-50 py-16">
        <div className="mx-auto w-full max-w-[1170px] px-4 sm:px-8 xl:px-0">
          ...
          <p className="mb-12 text-center text-slate-500 max-w-[640px] mx-auto">
            La natación como parte del menú de un club deportivo no es lo mismo que una academia dedicada a enseñar a nadar.
          </p>

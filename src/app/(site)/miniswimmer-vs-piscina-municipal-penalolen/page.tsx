...
export const metadata: Metadata = {
	...
	alternates: {
		canonical: 'https://miniswimmer.cl/miniswimmer-vs-piscina-municipal-penalolen',
		languages: {
			'x-default': 'https://miniswimmer.cl/miniswimmer-vs-piscina-municipal-penalolen',
...
const breadcrumbSchema = {
	...
	"itemListElement": [
		...
		{ "@type": "ListItem", "position": 2, "name": "Clases Natación Peñalolén", "item": "https://miniswimmer.cl/clases-natacion-penalolen" },
		{ "@type": "ListItem", "position": 3, "name": "Miniswimmer vs Piscina Municipal Peñalolén", "item": "https://miniswimmer.cl/miniswimmer-vs-piscina-municipal-penalolen" }
	]
};

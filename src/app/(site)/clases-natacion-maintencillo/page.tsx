...
const localBusinessSchema = {
	...
	"@id": "https://miniswimmer.cl/clases-natacion-maintencillo#localbusiness",
	"name": "Miniswimmer — Clases de Natación en Maitencillo",
	"url": "https://miniswimmer.cl/clases-natacion-maintencillo",
	"image": "https://images.prismic.io/miniswimmerchile/aLToIWGNHVfTOeON_SOCIAL-MEDIA-Maintencillo.png?auto=format,compress",
	"logo": {
		"@type": "ImageObject",
		"url": "https://miniswimmer.cl/images/logo/logo.svg"
	},
	"description": "Clases de natación en Maitencillo, Zapallar, Cachagua, Marbella, Papudo, Puchuncaví y La Ligua. Método Miniswimmer: Natación + PNL y Coaching. Lecciones personalizadas para bebés y niños.",
	...
	"areaServed": ["Maitencillo", "Zapallar", "Cachagua", "Marbella", "Papudo", "Puchuncaví", "La Ligua"],
...
const breadcrumbSchema = {
	...
	"itemListElement": [
		...
		{ "@type": "ListItem", "position": 2, "name": "Clases de Natación en Maitencillo", "item": "https://miniswimmer.cl/clases-natacion-maintencillo" }
	]
};

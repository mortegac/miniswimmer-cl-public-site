...
const organizationSchema = {
  ...
  description:
    "Academia de natación con el Método Miniswimmer, que combina natación con Programación Neurolingüística (PNL) y coaching. Clases para bebés, niños, adultos y embarazadas en Chile y Estados Unidos.",
  ...
  areaServed: [
    {
      ...
      name: "Peñalolén, Región Metropolitana, Chile",
    },

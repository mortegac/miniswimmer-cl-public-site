...
export const metadata: Metadata = {
	...
	description: "Programa de natación especializado para niños con Trastorno del Espectro Autista (TEA) y neurodivergencia. Método Miniswimmer con PNL, coaches certificados y ambiente seguro. ¡Inscríbelos hoy!",
	alternates: {
	...
	openGraph: {
		...
		title: "Neuro Swimmer | Natación Adaptada para Niños con TEA — Miniswimmer",
		description: "Programa de natación especializado para niños con Trastorno del Espectro Autista (TEA) y neurodivergencia. Método Miniswimmer con PNL, coaches certificados y ambiente seguro.",
		images: [
			{
...
const serviceSchema = {
	...
	"name": "Neuro Swimmer",
	"url": "https://miniswimmer.cl/neuro-swimmer",
	"description": "Programa de natación especializado para niños con Trastorno del Espectro Autista (TEA) y otras condiciones neurodivergentes. Integra Programación Neurolingüística (PNL), enfoque terapéutico y coaches certificados.",
	"provider": {
		"@type": "Organization",
	...
	"audience": {
		"@type": "Audience",
		"audienceType": "Niños con Trastorno del Espectro Autista y condiciones neurodivergentes"
	},
	"areaServed": {
		"@type": "Country",
		"name": "Chile"
...
const breadcrumbSchema = {
	...
	"itemListElement": [
		...
		{ "@type": "ListItem", "position": 2, "name": "Servicios", "item": "https://miniswimmer.cl/servicios" },
		{ "@type": "ListItem", "position": 3, "name": "Neuro Swimmer", "item": "https://miniswimmer.cl/neuro-swimmer" }
	]
};
